...
SRCS =	ft_strtrim.c     ft_atoi.c         ft_isprint.c    ft_strlen.c\
		...
		ft_strncmp.c	ft_memchr.c 	ft_strjoin.c	ft_substr.c\
		ft_split.c	  ft_itoa.c	ft_strmapi.c ft_striteri.c ft_putstr_fd.c\
		ft_putendl_fd.c ft_putnbr_fd.c ft_putchar_fd.c
